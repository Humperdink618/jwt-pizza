                  ...
                  <div className="overflow-hidden">
                    <table className="min-w-full divide-y divide-gray-300">
                        ...
                        return (
                          <tbody key={uindex} className="divide-y divide-gray-200">
                            <tr className="border-neutral-500 border-t-2">
                              ...
                              <td className="text-start px-2 whitespace-nowrap text-sm font-normal text-gray-800" colSpan={2}>
                      ...
                      <tfoot>
                        <tr>
                          <td className="px-1 py-1">
                            <input type="text" ref={filterFranchiseRef} name="filterUser" placeholder="Name" className="px-2 py-1 text-sm border border-gray-300 rounded-lg" />
